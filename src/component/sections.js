	...
	return (
		<div className='header'>
			<h1 className='text-center'>
				Hi there!Lorem ipsum is placeholder text commonly used in the
		...
		<div className='services text-center '>
			...
			<div className='row container mx-auto'>
				<Item
					...
					image={flag}
					title='title'
					par='Lorem ipsum is placeholder text commonly used, and publishing industries for previewing layouts and visual mockups.'
				/>
				<Item
					hasSocial={false}
					class='col-sm-3'
		...
		<div className='jumbotron text-center text-grayish'>
			...
			<div className='col-7 mx-auto mb-5'>
				<p className='text-center'>
					{' '}
					Lorem ipsum is placeholder text commonly usedvisual mockups.
				</p>
			</div>
			...
			<div className='row container mx-auto'>
				...
				<Item
					hasSocial={true}
					social={['twitter', 'facebook', 'envelope']}
					class='col-sm-3'
					image={avatar}
					title='title'
					circle={true}
				...
				<Item
					hasSocial={true}
					social={['twitter', 'envelope', 'facebook', 'linkedin']}
					class='col-sm-3'
					image={avatar}
					title='title'
					circle={true}
...
const Skills = props => {
	return (
		<div className='text-center text-grayish p-5'>
			<div className='col-7 mx-auto'>
				<h1 className='text-center text-grayish text-uppercase'>
					We got Skills!
				</h1>
			</div>
			<div className='line'>
	...
	return (
		<div className='text-center bg-yellow p-5 portfolio'>
			...
			<div className='col-6 mx-auto mb-5'>
				<p className='text-center'>
					{' '}
					this is our portfolio and it is awesomeLorem ipsum is placeholder
					text commonly usedvisual mockups.
				</p>
			</div>

			<div className='container'>
				<div className='col-sm-4 mx-auto mb-5'>
					<ul className='nav'>
						<li className='nav-item'>
							<NavLink
								...
								className={`nav-link text-uppercase ${
									current === 'all' ? 'portfolio-active-link' : ''
								}`}
							>
								all
							</NavLink>
						...
						<li className='nav-item'>
							<NavLink
								...
								onClick={e => handleChange(e.target.name)}
								className={`nav-link text-uppercase ${
									current === 'web' ? 'portfolio-active-link' : ''
								}`}
							>
								web
							</NavLink>
						...
						<li className='nav-item'>
							<NavLink
								...
								onClick={e => handleChange(e.target.name)}
								className={`nav-link text-uppercase ${
									current === 'apps' ? 'portfolio-active-link' : ''
								}`}
							>
								apps
							</NavLink>
						...
						<li className='nav-item'>
							<NavLink
								...
								onClick={e => handleChange(e.target.name)}
								className={`nav-link text-uppercase ${
									current === 'icons' ? 'portfolio-active-link' : ''
								}`}
							>
								icon
							</NavLink>
			...
			<div className='contaienr'>
				<div className='col-5 mx-auto'>
					<div className='row'>
						...
						<div className='col-sm-5 ml-sm-5'>
							<div className='col-12'>
								<Laptop content={current} />
							</div>
							<p className='text-center mt-3'>some dummy text</p>
			...
			<div className='contaienr mt-sm-5'>
				<div className='col-5 mx-auto'>
					<div className='row'>
						<div className='col-sm-5'>
							<div className='col-12'>
		...
		<div className={props.class}>
			<div className='col-7 mx-auto mb-5'>
				<img
					src={props.image}
					height='100'
					className={`${props.circle && 'rounded-circle '}`}
				/>
			</div>
...
const Social = ({ social, isSocial }) => {
	if (isSocial) {
		return social.map((item, index) => (
			<span
				key={index}
				className={`col-2 ml-2 social-media fa fa-${item}`}
			/>
		));
	}
	return <div />;
